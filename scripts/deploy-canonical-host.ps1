...
try {
  ...
  $associations = @($distribution.DistributionConfig.DefaultCacheBehavior.FunctionAssociations.Items)
  ...
  $distribution.DistributionConfig | ConvertTo-Json -Depth 100 | Set-Content -LiteralPath $configPath -Encoding utf8NoBOM
